...
//   function User(surname, position) {
//     this.surname = surname; 
//     this.position = position;
//   }

//   const user = new User('Haxverdiyeva', 'scientist');
...
//     constructor(surname, age, position) { 
//         super(surname, age); 
//         this.position = position; 
//     } 
// } 
 
// const e = new Employee('Joe', 38, 'Doctor'); 
...
// const weirdo = new Weirdo('scientist'); 
...
// function lastThreeYears(date, mode = 'year') {  const currentYear = date.getFullYear();
//     const result = {};
//     for (let i = 0; i < 3; i++) {    const year = currentYear - i;
//       const yearData = [];
//       if (mode === 'month') {      for (let month = 0; month < 12; month++) {
//           if (year === currentYear && month > date.getMonth()) {          break;
//           }        yearData.push(month);
//         }    } else if (mode === 'quarter') {
//         for (let quarter = 1; quarter <= 4; quarter++) {        if (year === currentYear && quarter > Math.ceil((date.getMonth() + 1) / 3)) {
//             break;        }
//           yearData.push(quarter);      }
//       }
//       result[year] = yearData;  }
//     return mode === 'year' ? Object.keys(result).map(Number) : result;
//   }
