...
// const largeNum = BigInt("72345679775322345679865");
// console.log(largeNum + BigInt(45));
...
//     year: 2022,
//     fullCarDesription() {
//       return this.model + ' which was made with ' + this.make + ' in ' + this.year;
//     }
//   };
...
// const sentence = 'I need motivation';
// const word = 'need';
...
// const dateFirst = new Date(2023, 08, 04);
// const dateSecond = new Date(2023, 12, 21);
